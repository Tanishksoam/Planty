  ...
  return (
    <div className="w-full max-w-[960px] flex flex-col justify-start items-start py-10 gap-8">
      ...
      <div className="w-full flex justify-between items-start gap-6">
        <div className="w-1/3 min-h-full flex flex-col justify-start items-start gap-2 font-light text-[#dfdfdf] py-4 hover:border-b-2 hover:hover-[#dfdfdf] duration-75 ease-in">
          ...
          <ol className="list-decimal list-inside flex flex-col justify-start items-start gap-1">
            <li>Customizable plant selection</li>
            <li>Personalized gift card options</li>
            <li>Occasional delivery flexibility</li>
          </ol>
        </div>
        <div className="w-1/3 min-h-full flex flex-col justify-start items-start gap-2 font-light  text-[#dfdfdf] py-4 hover:border-b-2 hover:hover-[#dfdfdf] duration-75 ease-in">
